...
#define DEFAULT_LOG_FILE_DIR "nwlog"
...
namespace Vins
{
  ...
  {
    INFO_DUMP("---- nwlog configurations ----\n");
  ...
  int Logging::init(const std::string &app_name, bool log_to_file, std::string &log_file_dir, nwlog_level_e min_log_level)
  {
  ...
  int Logging::write_log(const char *module, nwlog_level_e level, const char *filename,
